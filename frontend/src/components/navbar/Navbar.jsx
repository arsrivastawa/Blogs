...
function Navbar({ userName }) {
  return (
    <>
      <div className="navbar-container lg:px-4 px-2 border-b-[1px] border-slate-300 fixed backdrop-blur-sm py-2 flex flex-row w-full justify-between items-center">
        <Link to={"/"}>
